$(document).ready(function () {
    ...
    $(".1_2").click(function () {
        ...
        $("#key").html("Recognise 2 –D shapes</br>Name 2 –D shapes</br>Compare 2-D shapes and explain how they are similar or different</br>Recognise different 3 –D shapes </br>Name different 3 –D shapes</br>Find everyday examples of 3-D shapes</br>Compare 3-D shapes and explain how they are similar or different</br>Identify examples of similar and different 2-D and 3-D shapes");
    });
    $(".1_3").click(function () {
