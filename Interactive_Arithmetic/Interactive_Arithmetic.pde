...
void renderPage() {
  ...
  case 4:
   ...
   case 5:
    ...
    answers[12]=String.format("%d",t1*t2);
  ...
  case 7:
    ...
    answers[19]=String.format("%.2f",(float)t1/100);
  ...
  case 8:
    ...
    answers[23]=String.format("%d",t1*t2);
    //textSize(12);
    textAlign(CENTER,CENTER);
  ...
  case 9:
    ...
    answers[26]=String.format("%d",t1*2 + t3);
    //textSize(12);
    textAlign(CENTER,CENTER);
    text(String.format("%d", t1), 125, 500+75-12);
    text(String.format("%d", t2), 125, 500+75+12);
  ...
  case 11:
    ...
    answers[30]=String.format("%d %d/%d",t4,t1*t2+t3,t2*2);
    ...
    answers[32]=String.format("1/%d",t2);
    textAlign(CENTER,CENTER);
    text(String.format("%d", t1), 125, 500+75-12);
    text(String.format("%d", t2), 125, 500+75+12);
    textSize(24);
  ...
  case 12:
    ...
    answers[33]=String.format("%d",(t3/t2)*t1);
    textAlign(CENTER,CENTER);
